"""Programa principal do meu_projeto.

Demonstra o uso do módulo calculadora com logging
de eventos e resultados.
"""
...
# Garante que o pacote seja encontrado ao rodar diretamente
